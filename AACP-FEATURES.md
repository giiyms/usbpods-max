...
Host-side policy (`src/btstack/dual_connect_policy.h`, `src/btstack/aacp_smart_routing.h`; tests in `tests/dual_connect_policy_test.c`, `tests/aacp_smart_routing_test.c`, `tests/aacp_dump_replay_test.c`):
